...
import { Home, Users, Heart, Shield, Activity, CheckCircle } from "lucide-react";
...
export default function ServicesPage() {
  return (
    <>
      ...
      >
        <div aria-hidden style={{ position: "absolute", top: "-80px", left: "-80px", width: "300px", height: "300px", borderRadius: "50%", background: "rgba(245,158,11,0.1)", pointerEvents: "none" }} />
        ...
        <div style={{ maxWidth: "700px", margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", gap: "16px", justifyContent: "center", flexWrap: "wrap" }}>
            <a
              ...
              style={{ fontFamily: "'Nunito', sans-serif", fontWeight: 700, fontSize: "16px", background: "#B45309", color: "#fff", padding: "16px 32px", borderRadius: "12px", textDecoration: "none" }}
            >
              Call Us Today
            </a>
            <Link
              href="/contact"
              style={{ fontFamily: "'Nunito', sans-serif", fontWeight: 700, fontSize: "16px", background: "#1E4D7B", color: "#fff", padding: "16px 32px", borderRadius: "12px", textDecoration: "none" }}
            >
              Make an Enquiry
            </Link>
          </div>
